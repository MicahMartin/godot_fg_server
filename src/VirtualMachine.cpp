...
//        }
      ...
      case OP_GET_ENTITY_STATUS: {
        ...
        godot::UtilityFunctions::print("checked entity status for ", (int)operand, " got ", (int)val);
      ...
      default: {
        godot::UtilityFunctions::print("invalid opcode");
       break;
     }
    }
  }
...
void VirtualMachine::runtimeError(const char* format, ...) {
  godot::UtilityFunctions::print("Runtime error");
  va_list args;
